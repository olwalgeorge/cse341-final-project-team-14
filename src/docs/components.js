  ...
  schemas: {
    ...
    Product: {
      ...
      properties: {
        ...
        description: { type: 'string', example: 'Latest MacBook Pro with M3 chip' },
        ...
        items: {
          ...
          items: {
            ...
            properties: {
              ...
              price: { type: 'number', example: 1800.00 }
            }
          }
        },
        totalAmount: { type: 'number', example: 9000.00 },
        purchaseDate: { type: 'string', format: 'date-time' },
        status: { type: 'string', enum: ['pending', 'ordered', 'received', 'cancelled', 'returned'] },
        paymentStatus: { type: 'string', enum: ['unpaid', 'partially_paid', 'paid'] },
        paymentDue: { type: 'string', format: 'date-time' },
        notes: { type: 'string', example: 'Bulk purchase of laptops for inventory' },
        createdAt: { type: 'string', format: 'date-time' },
        updatedAt: { type: 'string', format: 'date-time' }
      }
    },
        ...
        'application/json': {
          schema: {
            ...
            properties: {
              ...
              error: { type: 'string', example: 'Validation error: Name is required' }
            }
          }
        }
      }
