...
router.get('/supplierID/:supplierID', isAuthenticated, validate(supplierIDValidationRules()), getSupplierBySupplierID);
router.get('/name/:name', isAuthenticated, getSupplierByName);
router.get('/:_id', isAuthenticated, validate(supplier_IdValidationRules()), getSupplierById);
router.post('/', isAuthenticated, createSupplier);
router.put('/:_id', isAuthenticated, validate(supplier_IdValidationRules()), validate(supplierUpdateValidationRules()), updateSupplierById);
